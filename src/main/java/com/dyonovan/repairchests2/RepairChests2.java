...
import com.dyonovan.repairchests2.providers.*;
...
public class RepairChests2
{
    ...
    public void gatherData(GatherDataEvent.Client event) {
        ...
        gen.addProvider(true, new RCSpriteSourceProvider(packOutput, lookupProvider));
        gen.addProvider(true, new RCModelProvider(packOutput));
        gen.addProvider(true, new RCLootTableProvider(packOutput, lookupProvider));
        gen.addProvider(true, new RCRecipeProvider.Runner(packOutput, lookupProvider));
    }
